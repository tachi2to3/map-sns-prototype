                 ...
                 >
                    <div className="flex p-3 gap-4">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center">
                        <h4 className="text-white font-medium leading-snug line-clamp-2 mb-2">
                          {post.caption}
                        </h4>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            {/* ★追加: ユーザーアイコン */}
                            {post.userIcon ? (
                              <img src={post.userIcon} alt="" className="w-5 h-5 rounded-full object-cover border border-white/10" />
                            ) : (
